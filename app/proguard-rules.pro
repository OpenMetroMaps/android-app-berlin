...
-assumenosideeffects class de.topobyte.sulfur.util.AndroidTimeUtil {
    public static void time(...);
}

-assumenosideeffects class de.topobyte.sulfur.util.TimeCounter {
...
-dontwarn de.topobyte.krypton.viewer.core.**
-dontwarn de.topobyte.lightgeom.curves.spline.awt.**
